...
#Outcome data extracted from Lesseur et al. GWAS (available via IEU OpenGWAS project and dbGaP)

exposure_dat <- read_exposure_data("afs_exposure.txt", sep="\t")
outcome_dat <- read_outcome_data("afs_opc.txt", sep="\t")
dat <- harmonise_data(exposure_dat, outcome_dat)
dat$outcome <- "Oropharyngeal cancer"
dat$exposure <- "Age at First Sex"
write.csv(dat, "afs_opc_harmonised.csv")    
mr_results <- mr(dat)
mr_results
or_results <- generate_odds_ratios(mr_results)
or_results
mr_report(dat, output_path = "~/filepath", author="Mark Gormley", study = paste("Age at First Sex","Oropharyngeal cancer",sep=""))
...
write.table(results, "afs_opc_results.txt")

Het<-mr_heterogeneity(dat)
Plt<-mr_pleiotropy_test(dat)
Sin<-mr_singlesnp(dat)
write.table(Het, "afs_opc_heterogeneity.txt")
write.table(Plt, "afs_opc_pleiotropy.txt")
write.table(Sin, "afs_opc_single_snp.txt")
...
write.csv(ivwrad$sortoutliers, "afs_opc_outliers.csv", row.names=F, quote=F)
...
results<-cbind.data.frame(or_results$outcome,or_results$nsnp,or_results$method,or_results$b,or_results$se,or_results$pval,or_results$or,or_results$or_lci95,or_results$or_uci95)
write.table(results, "afs_opc_nooutliers.txt")

#MR presso 
outcome_dat <- read_outcome_data("afs_exposure.txt", sep="\t", snp_col="rs", beta_col = "est", se_col="SE", effect_allele_col="eff_all",other_allele_col = "other_all", pval_col = "P")
dat <- harmonise_data(exposure_dat, outcome_dat)
...
mr_presso
write.table(mr_presso, "afs_opc_mr_presso.txt")
...
#F-statistic
dat$samplesize.exposure <- 397338
...
OR = exp( -4.25767) 
CIL = exp(-4.25767 - 1.96 * 1.17666) 
CIU = exp(-4.25767 + 1.96 * 1.17666) 


#Regional Oropharyngeal cancer analysis

exposure_dat <- read_exposure_data("afs_exposure_region.txt", sep="\t")
...
or_results <- generate_odds_ratios(mr_results)
or_results
write.table(or_results, "opc_afs_europe_results.txt")
...
or_results <- generate_odds_ratios(mr_results)
or_results
write.table(or_results, "opc_afs_northamerican_results.txt")

exposure_dat <- read_exposure_data("afs_exposure_region", sep="\t")
...
or_results <- generate_odds_ratios(mr_results)
or_results
write.table(or_results, "opc_afs_southamerican_results.txt")
...
exposure_dat <- read_exposure_data("afs_exposure.txt", sep="\t")
outcome_dat <- read_outcome_data("afs_cervical_ukbb_lk.txt", sep="\t")
dat <- harmonise_data(exposure_dat, outcome_dat)
...
or_results <- generate_odds_ratios(mr_results)
or_results
mr_report(dat, output_path = "~/filepath", author="Mark Gormley", study = paste("Age at First Sex","Cervical cancer",sep=""))
write.table(or_results, "afs_cervical_cancer_results_lk.txt")

Het<-mr_heterogeneity(dat)
Plt<-mr_pleiotropy_test(dat)
Sin<-mr_singlesnp(dat)
write.table(Het, "afs_cervical_heterogeneity.txt")
write.table(Plt, "afs_cervical_pleiotropy.txt")
write.table(Sin, "afs_cervical_single_snp.txt")
p1 <- mr_scatter_plot(mr_results, dat)
p1[[1]]
...
ivwrad$sortoutliers$Qsum <- cumsum(ivwrad$sortoutliers$Q_statistic)
ivwrad$sortoutliers$Qdif <- ivwrad$sortoutliers$Qsum - ivwrad$qstatistic
write.csv(ivwrad$sortoutliers, "afs_cervical_outliers.csv", row.names=F, quote=F)
...
results<-cbind.data.frame(or_results$outcome,or_results$nsnp,or_results$method,or_results$b,or_results$se,or_results$pval,or_results$or,or_results$or_lci95,or_results$or_uci95)
write.table(results, "afs_cervical_nooutliers.txt")
...
mr_presso <- mr_presso(BetaOutcome = "beta.outcome", BetaExposure = "beta.exposure", SdOutcome = "se.outcome", SdExposure = "se.exposure", OUTLIERtest = TRUE, DISTORTIONtest = TRUE, data = dat, NbDistribution = 1000,  SignifThreshold = 0.05)
mr_presso
write.table(mr_presso, "afs_cervical_mr_presso.txt")

#Chlamydia infection
#Outcome data extracted from a GWAS using UKBB data
exposure_dat <- read_exposure_data("afs_exposure.txt", sep="\t")
outcome_dat <- read_outcome_data("afs_chlamydia.txt", sep="\t")
dat <- harmonise_data(exposure_dat, outcome_dat)
...
or_results <- generate_odds_ratios(mr_results)
or_results
mr_report(dat, output_path = "~/filepath", author="Mark Gormley", study = paste("Age at first sex","Chlamydia infection",sep=""))
write.table(or_results, "afs_chlamydia_results.txt")

Het<-mr_heterogeneity(dat)
Plt<-mr_pleiotropy_test(dat)
Sin<-mr_singlesnp(dat)
write.table(Het, "afs_chlamydia_heterogeneity.txt")
write.table(Plt, "afs_chlamydia_pleiotropy.txt")
write.table(Sin, "afs_chlamydia_single_snp.txt")
p1 <- mr_scatter_plot(mr_results, dat)
p1[[1]]
...
ivwrad$sortoutliers$Qsum <- cumsum(ivwrad$sortoutliers$Q_statistic)
ivwrad$sortoutliers$Qdif <- ivwrad$sortoutliers$Qsum - ivwrad$qstatistic
write.csv(ivwrad$sortoutliers, "afs_chlamydia_outliers.csv", row.names=F, quote=F)
...
results<-cbind.data.frame(or_results$outcome,or_results$nsnp,or_results$method,or_results$b,or_results$se,or_results$pval,or_results$or,or_results$or_lci95,or_results$or_uci95)
write.table(results, "afs_chlamydia_nooutliers.txt")
...
mr_presso <- mr_presso(BetaOutcome = "beta.outcome", BetaExposure = "beta.exposure", SdOutcome = "se.outcome", SdExposure = "se.exposure", OUTLIERtest = TRUE, DISTORTIONtest = TRUE, data = dat, NbDistribution = 1000,  SignifThreshold = 0.05)
mr_presso
write.table(mr_presso, "afs_chlamydia_mr_presso.txt") 
...
or_results <- generate_odds_ratios(mr_results)
or_results
mr_report(dat, output_path = "~/filepath", author="Mark Gormley", study = paste("Age at First Sex","Lung cancer",sep=""))
write.table(or_results, "afs_lung_results.txt")

Het<-mr_heterogeneity(dat)
Plt<-mr_pleiotropy_test(dat)
Sin<-mr_singlesnp(dat)
write.table(Het, "afs_lung_heterogeneity.txt")
write.table(Plt, "afs_lung_pleiotropy.txt")
write.table(Sin, "afs_lung_single_snp.txt")
p1 <- mr_scatter_plot(mr_results, dat)
p1[[1]]
...
ivwrad$sortoutliers$Qsum <- cumsum(ivwrad$sortoutliers$Q_statistic)
ivwrad$sortoutliers$Qdif <- ivwrad$sortoutliers$Qsum - ivwrad$qstatistic
write.csv(ivwrad$sortoutliers, "afs_lung_outliers.csv", row.names=F, quote=F)
...
results<-cbind.data.frame(or_results$outcome,or_results$nsnp,or_results$method,or_results$b,or_results$se,or_results$pval,or_results$or,or_results$or_lci95,or_results$or_uci95)
write.table(results, "afs_lung_nooutliers.txt")
...
mr_presso <- mr_presso(BetaOutcome = "beta.outcome", BetaExposure = "beta.exposure", SdOutcome = "se.outcome", SdExposure = "se.exposure", OUTLIERtest = TRUE, DISTORTIONtest = TRUE, data = dat, NbDistribution = 1000,  SignifThreshold = 0.05)
mr_presso
write.table(mr_presso, "afs_lung_mr_presso.txt")

#Oral cancer
#Outcome data extracted from Lesseur et al. GWAS available in IEU OpenGWAS project
exposure_dat <- read_exposure_data("afs_exposure.txt", sep="\t")
outcome_dat <- read_outcome_data("afs_oc.txt", sep="\t")
dat <- harmonise_data(exposure_dat, outcome_dat)
...
or_results <- generate_odds_ratios(mr_results)
or_results
mr_report(dat, output_path = "~/filepath", author="Mark Gormley", study = paste("Age at First Sex","Oral cancer",sep=""))
write.table(or_results, "afs_oc_results.txt")

Het<-mr_heterogeneity(dat)
Plt<-mr_pleiotropy_test(dat)
Sin<-mr_singlesnp(dat)
write.table(Het, "afs_oc_heterogeneity.txt")
write.table(Plt, "afs_oc_pleiotropy.txt")
write.table(Sin, "afs_oc_single_snp.txt")
p1 <- mr_scatter_plot(mr_results, dat)
p1[[1]]
...
ivwrad$sortoutliers$Qsum <- cumsum(ivwrad$sortoutliers$Q_statistic)
ivwrad$sortoutliers$Qdif <- ivwrad$sortoutliers$Qsum - ivwrad$qstatistic
write.csv(ivwrad$sortoutliers, "afs_oc_outliers.csv", row.names=F, quote=F)
...
results<-cbind.data.frame(or_results$outcome,or_results$nsnp,or_results$method,or_results$b,or_results$se,or_results$pval,or_results$or,or_results$or_lci95,or_results$or_uci95)
write.table(results, "afs_oc_nooutliers.txt")
...
mr_presso <- mr_presso(BetaOutcome = "beta.outcome", BetaExposure = "beta.exposure", SdOutcome = "se.outcome", SdExposure = "se.exposure", OUTLIERtest = TRUE, DISTORTIONtest = TRUE, data = dat, NbDistribution = 1000,  SignifThreshold = 0.05)
mr_presso
write.table(mr_presso, "afs_oc_mr_presso.txt")
